 ...
 */
final class Version20230418021220 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE medecin (id INT AUTO_INCREMENT NOT NULL, specialite_id INT NOT NULL, categorie_id INT NOT NULL, nationalite_id INT DEFAULT NULL, matricule VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance DATE DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, tel VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_1BDA53C62195E0F0 (specialite_id), INDEX IDX_1BDA53C6BCF5E72D (categorie_id), INDEX IDX_1BDA53C61B063272 (nationalite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rdv (id INT AUTO_INCREMENT NOT NULL, horaire_id INT NOT NULL, patient_id INT NOT NULL, numero INT NOT NULL, annee INT NOT NULL, date_rdv DATE NOT NULL, obervation VARCHAR(255) NOT NULL, INDEX IDX_10C31F8658C54515 (horaire_id), INDEX IDX_10C31F866B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE patient ADD nationlite_id INT NOT NULL, ADD domaine_id INT DEFAULT NULL, ADD assureur_id INT DEFAULT NULL, DROP assureur');
        $this->addSql('ALTER TABLE patient ADD CONSTRAINT FK_1ADAD7EB97636723 FOREIGN KEY (nationlite_id) REFERENCES nationalite (id)');
        ...
        $this->addSql('CREATE INDEX IDX_1ADAD7EB97636723 ON patient (nationlite_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patient DROP FOREIGN KEY FK_1ADAD7EB97636723');
        ...
        $this->addSql('DROP INDEX IDX_1ADAD7EB97636723 ON patient');
        $this->addSql('DROP INDEX IDX_1ADAD7EB4272FC9F ON patient');
        $this->addSql('DROP INDEX IDX_1ADAD7EB80F7E20A ON patient');
        $this->addSql('ALTER TABLE patient ADD assureur VARCHAR(255) NOT NULL, DROP nationlite_id, DROP domaine_id, DROP assureur_id');
    }
}
